...
protected:
	...
	BOOL Lf_setExecuteMesDSPM();
	BOOL Lf_setExecuteMesDMIN();
	BOOL Lf_setExecuteMesDMOU();
...
public:
	...
	afx_msg void OnBnClickedBtnPiMesDspm();
	afx_msg void OnBnClickedBtnPiMesDmin();
	afx_msg void OnBnClickedBtnPiMesDmou();
